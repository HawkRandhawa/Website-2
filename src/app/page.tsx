            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div
                  whileFocus={{ scale: 1.02 }}
                >
                  <label className="block text-white font-semibold mb-2">Upload Photo (Optional)</label>
                  <input
                    type="file"
                    accept="image/*"
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Upload a photo of the electrical issue for better assessment
                  </p>
                </motion.div>

                <motion.button
                  type="submit"
                  className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-black py-4 rounded-lg text-lg font-semibold shadow-lg"
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 20px 40px rgba(251, 191, 36, 0.4)"
                  }}
